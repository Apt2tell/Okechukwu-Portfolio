...
function dataFeeder(num) {
  if (num === 1) {
    ...
    document.getElementById('modal-image-1').src = './images/Snapshoot-Portfolio-desktop1.svg';
  } else if (num === 2) {
    ...
    document.getElementById('modal-image-1').src = './images/Snapshoot-Portfolio-desktop2.svg';
  } else if (num === 3) {
    ...
    document.getElementById('modal-image-1').src = './images/Snapshoot-Portfolio-desktop3.svg';
  } else if (num === 4) {
    ...
    document.getElementById('modal-image-1').src = './images/Snapshoot-Portfolio-desktop4.svg';
  }
}
